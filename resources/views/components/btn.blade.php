...
@php
   $colors = [
      ...
      'transp'    => '!shadow-none bg-transparent border-success/0 text-success-d1 dark:text-success-l1 hover:bg-success/20 dark:hover:bg-success-l1/20 focus:bg-success/20 dark:focus:bg-success-l1/20 active:bg-success-d1/20 dark:active:bg-success/20 focus:border-success-d1/40 dark:focus:border-success/40',
